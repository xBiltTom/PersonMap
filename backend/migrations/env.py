...
# La URL vive en .env, no en alembic.ini: así la migración usa exactamente la
# misma base de datos que la aplicación y no hay dos fuentes de verdad que
# puedan divergir. El .ini queda con un valor de marcador.
