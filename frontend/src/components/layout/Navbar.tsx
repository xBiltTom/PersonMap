...
import { Shield, Radio, Layers, KeyRound } from "lucide-react";
    ...
    <header className="border-b border-[#1e293b] bg-[#0b0f17]/95 sticky top-0 z-50 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-4 min-w-0 overflow-x-auto">
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-md bg-[#121824] border border-[#1e293b] text-xs font-mono shrink-0">
            <Radio
          ...
          <Link
            ...
            className={`flex items-center gap-1.5 text-xs font-mono px-3 py-1.5 rounded-md border transition-colors shrink-0 whitespace-nowrap ${
              pathname === "/"
          ...
          <Link
            href="/seguridad"
            aria-current={pathname === "/seguridad" ? "page" : undefined}
            className={`flex items-center gap-1.5 text-xs font-mono px-3 py-1.5 rounded-md border transition-colors shrink-0 whitespace-nowrap ${
              pathname === "/seguridad"
